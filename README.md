...
標本平均のヒストグラムと，標本平均の平均がサンプル数を増やすとどのように収束するかをPNGとして表示・ダウンロードできます．
...
4. メイン画面にヒストグラムとランニング平均のグラフが表示されます．各グラフ下のボタンからPNGをダウンロードできます（ファイル名に n と m を含めています）．

## 補足
- サンプルサイズ n を大きくするとヒストグラムは正規分布に近づきます（中心極限定理）．
- Sample count m を大きくするとランニング平均が 3.5 に安定して近づく様子が見られます（大数の法則）．
